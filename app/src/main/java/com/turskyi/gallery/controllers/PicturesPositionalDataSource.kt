...
class PicturesPositionalDataSource(private val context: Context) : PositionalDataSource<GalleryPicture>() {
    ...
    override fun loadInitial(params: LoadInitialParams, callback: LoadInitialCallback<GalleryPicture>) {
        ...
        val list = repository.getDataOfImageList(params.requestedStartPosition, params.requestedLoadSize, context)
    ...
    override fun loadRange(params: PositionalDataSource.LoadRangeParams, callback: PositionalDataSource.LoadRangeCallback<GalleryPicture>) {
        ...
        val list = repository.getDataOfImageList(params.startPosition, params.loadSize, context)
